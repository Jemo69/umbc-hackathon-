  ...
  return (
    <nav
      className={`fixed top-0 left-0 right-0 z-40 transition-all duration-300 ${
        isScrolled ? "liquid-glass-nav shadow-m3-2" : "bg-transparent"
      }`}
    >
  ...
  return (
    <div className="m3-surface p-6 interactive animate-m3-fade-in">
      <div className="flex items-center justify-between mb-4">
        <div
          className={`w-12 h-12 rounded-m3-xl flex items-center justify-center ${
            color === "primary"
...
const QuickActionCard = ({
  ...
  >
    <div
      className={`w-12 h-12 rounded-m3-xl flex items-center justify-center mb-4 ${
        color === "primary"
...
const TaskPreview = ({ task }: { task: Doc<"todos"> }) => (
  <div className="liquid-glass p-4 rounded-m3-lg border border-surface-200 hover:border-primary-300 transition-colors">
    ...
    <div className="flex items-center justify-between text-body-small">
      ...
      {task.dueDate && (
        <span
          className={`px-2 py-1 rounded-m3-sm ${
          ...
          <div className="container mx-auto px-4 sm:px-6 lg:px-8 py-12">
            <div className="max-w-4xl mx-auto text-center">
              ...
              <div className="flex flex-wrap justify-center gap-4 animate-m3-bounce">
                <div className="flex items-center space-x-2 bg-white/80 backdrop-blur-sm px-4 py-2 rounded-m3-xl border border-surface-200">
            ...
            <div className="mb-8">
              ...
              <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
                ...
                <div className="text-center p-4 bg-purple-50 rounded-m3-xl border border-purple-200">
                  ...
                  <p className="text-body-small text-purple-600">
                    7 day study streak
                  </p>
                </div>
